...
# Получаем объект службы по имени
...
if ($serviceStatus) {
    ...
    if ($serviceStatus.Status -eq 'Running') {
        ...
        Write-Host "Служба 'DPS' включена и работает. PID: $($serviceProcess.ProcessId)"
        ...
        Write-Host "Служба '$service' не запущена."
    }
...
if ($serviceStatus) {
    ...
    if ($serviceStatus.Status -eq 'Running') {
        ...
        Write-Host "Служба 'PcaSvc' включена и работает. PID: $($serviceProcess.ProcessId)"
